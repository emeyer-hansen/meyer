...
pracSigLevel <- function(effect_sizes = NULL, type = 'd', rules = 'cohen1988'){
  ...
  if(type=='r' | type=='eta' | type=='epsilon' | type=='omega'){
    if(rules != 'cohen1988' & rules != 'evans1996' & rules != 'lovakov2021' & rules != 'gignac2016') stop('only supported rules for the selected type are \'cohen1988\', \'evans1996\', \'lovakov2021\', and \'gignac2016\'')
  }
