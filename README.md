...
# Rescale data as correlation coefficients with `meyerization`
...
# Determining df for prior Student t-distribution with `meyersDF`
...
# Assess 'Exaggeration Level' with `typeMlevel`
...
# Catch-all Detection of 'Missingness' with `is.missing`
...
Neyman, J. & E. S. Pearson (1933): 'The Testing of Statistical Hypotheses in Relation to Probabilities a priori', Mathematical Proceedings of the Cambridge Philosophical Society, 29(4): 492-510.Pearson, K. (1900): 'On the criterion that a given system of deviations from the probable in the case of a correlated system of variables is such that it can be reasonably supposed to have arisen from random sampling', Philosophical Magazine, 50(302): 157-175.
