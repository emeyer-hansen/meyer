...
Unlike other approaches, this formula ensures that the rescaled vector *x* has an approximate mean of 0, and assuming *x* is normally distributed, an asymptotic range [-1; 1].
...
---
Revised 5.12.2023 - [Emil Niclas Meyer-Hansen](emil098meyerhansen@gmail.com)
